...
const Dashboard = () => {
  ...
  const carNames = [
    "Toyota Corolla", "Honda Civic", "Suzuki Alto", "Suzuki Cultus", "Toyota Hilux", 
    "Kia Sportage", "Hyundai Tucson", "Honda City", "Toyota Fortuner", "Suzuki Wagon R", 
    "Nissan Sunny", "Mitsubishi Lancer", "Mercedes-Benz C-Class", "BMW 3 Series",
    "Audi A4", "Ford Ranger", "Hyundai Elantra", "Toyota Prius", "Tesla Model 3",
    "MG HS", "Changan Alsvin", "Daihatsu Mira", "Suzuki Swift", "Toyota Yaris"
  ];
  ...
  const cities = [
    ...
    "Khushab", "Lahore", "Layyah", "Lodhran", "Mandi Bahauddin", "Mianwali", "Multan", "Muzaffargarh",
    "Nankana Sahib", "Narowal", "Okara", "Pakpattan", "Rahim Yar Khan", "Rajanpur", "Rawalpindi",
    ...
    "Hangu", "Haripur", "Karak", "Kohat", "Kohistan", "Lakki Marwat", "Lower Dir", "Malakand",
    "Mansehra", "Mardan", "Nowshera", "Peshawar", "Shangla", "Swabi", "Swat", "Tank", "Torghar", "Upper Dir",
    "Awaran", "Barkhan", "Chagai", "Dera Bugti", "Gwadar", "Harnai", "Jafarabad", "Jhal Magsi",
    "Kachhi", "Kalat", "Kech", "Kharan", "Khuzdar", "Kohlu", "Lasbela", "Loralai", "Mastung",
    "Musakhel", "Nasirabad", "Nushki", "Panjgur", "Pishin", "Quetta", "Sherani", "Sibi", "Sohbatpur",
    "Washuk", "Zhob", "Ziarat",
    "Badin", "Dadu", "Ghotki", "Hyderabad", "Jacobabad", "Jamshoro", "Kamber Shahdadkot",
    "Karachi Central", "Karachi East", "Karachi South", "Karachi West", "Kashmore", "Khairpur",
    "Korangi", "Larkana", "Matiari", "Mirpur Khas", "Naushahro Feroze", "Shaheed Benazirabad",
    "Sanghar", "Shikarpur", "Sujawal", "Sukkur", "Tando Allahyar", "Tando Muhammad Khan", "Tharparkar",
    "Thatta", "Umerkot"
  ];
